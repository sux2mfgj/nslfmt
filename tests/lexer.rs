...
fn get_token_eop() {
    ...
    assert_eq!(l.next(), Token::from((TokenClass::EndOfProgram, 1)));
}
...
fn get_token_new_line() {
    let mut b = "\n".as_bytes();
    let mut l = Lexer::new(&mut b);
    assert_eq!(l.next(), Token::from((TokenClass::EndOfProgram, 2)));
}
...
fn get_token_str() {
    ...
    let mut l = Lexer::new(&mut b);
    assert_eq!(l.next(), Token::new(TokenClass::Symbol(Symbol::Declare), 1));
}
...
fn declare_with_input() {
    ...
    assert_eq!(l.next(), Token::new(TokenClass::Symbol(Symbol::Input), 3));
    assert_eq!(
        l.next(),
...
fn declare_func_in() {
    ...
    assert_eq!(l.next(), Token::new(TokenClass::Symbol(Symbol::FuncIn), 4));
    assert_eq!(
        l.next(),
...
fn declare_func_out() {
    ...
    assert_eq!(l.next(), Token::new(TokenClass::Symbol(Symbol::Input), 4));
    assert_eq!(
        l.next(),
    ...
    assert_eq!(l.next(), Token::new(TokenClass::Symbol(Symbol::Output), 5));
    assert_eq!(
        l.next(),
    ...
    assert_eq!(l.next(), Token::new(TokenClass::Symbol(Symbol::FuncIn), 7));
    assert_eq!(
        l.next(),
    ...
    assert_eq!(l.next(), Token::new(TokenClass::Symbol(Symbol::FuncOut), 8));
    assert_eq!(
        l.next(),
    ...
    assert_eq!(l.next(), Token::new(TokenClass::Symbol(Symbol::Colon), 8));
    assert_eq!(
        l.next(),
    ...
    assert_eq!(l.next(), Token::new(TokenClass::EndOfProgram, 10));
}
...
fn number() {
    ...
    assert_eq!(l.next(), Token::new(TokenClass::Symbol(Symbol::Input), 1));
    assert_eq!(
        l.next(),
...
fn declare_04() {
    ...
    assert_eq!(l.next(), Token::new(TokenClass::Symbol(Symbol::FuncIn), 6));
    assert_eq!(
        l.next(),
    ...
    assert_eq!(l.next(), Token::new(TokenClass::Symbol(Symbol::Comma), 6));
    assert_eq!(
        l.next(),
...
fn macro_include() {
    ...
    let mut l = Lexer::new(&mut b);
    assert_eq!(l.next(), Token::new(TokenClass::Symbol(Symbol::Sharp), 1));
    assert_eq!(l.next(), Token::new(TokenClass::Macro(Macro::Include), 1));
    assert_eq!(
        l.next(),
        Token::new(TokenClass::String("hello.h".to_string()), 1)
    );
    assert_eq!(l.next(), Token::new(TokenClass::Symbol(Symbol::Declare), 2));
    assert_eq!(
        l.next(),
...
fn macro_undef() {
    ...
    let mut l = Lexer::new(&mut b);
    assert_eq!(l.next(), Token::new(TokenClass::Symbol(Symbol::Sharp), 1));
    assert_eq!(l.next(), Token::new(TokenClass::Macro(Macro::Undef), 1));
    assert_eq!(
        l.next(),
...
fn macro_ifdef() {
    ...
    let mut l = Lexer::new(&mut b);
    assert_eq!(l.next(), Token::new(TokenClass::Symbol(Symbol::Sharp), 1));
    assert_eq!(l.next(), Token::new(TokenClass::Macro(Macro::Ifdef), 1));
    assert_eq!(
        l.next(),
        Token::new(TokenClass::Identifire("aaaa".to_string()), 1)
    );
...
fn macro_ifndef() {
    ...
    let mut l = Lexer::new(&mut b);
    assert_eq!(l.next(), Token::new(TokenClass::Symbol(Symbol::Sharp), 1));
    assert_eq!(l.next(), Token::new(TokenClass::Macro(Macro::Ifndef), 1));
    assert_eq!(
        l.next(),
        Token::new(TokenClass::Identifire("aaaa".to_string()), 1)
    );
...
fn macro_else() {
    ...
    let mut l = Lexer::new(&mut b);
    assert_eq!(l.next(), Token::from((Symbol::Sharp, 1)),);
    assert_eq!(l.next(), Token::from((Symbol::Else, 1)),);
}
...
fn macro_endif() {
    ...
    let mut l = Lexer::new(&mut b);
    assert_eq!(l.next(), Token::new(TokenClass::Symbol(Symbol::Sharp), 1));
    assert_eq!(l.next(), Token::new(TokenClass::Macro(Macro::Endif), 1));
    assert_eq!(l.next(), Token::new(TokenClass::EndOfProgram, 1));
}
...
fn macro_define() {
    ...
    let mut l = Lexer::new(&mut b);
    assert_eq!(l.next(), Token::new(TokenClass::Symbol(Symbol::Sharp), 1));
    assert_eq!(l.next(), Token::new(TokenClass::Macro(Macro::Define), 1));
    assert_eq!(
        l.next(),
        Token::new(TokenClass::Identifire("HELLO".to_string()), 1)
    );
...
fn newline_in_declare_block() {
    ...
    assert_eq!(l.next(), Token::new(TokenClass::EndOfProgram, 2));
}
...
fn mutiline_comment_00() {
    ...
    assert_eq!(l.next(), Token::new(TokenClass::CStyleComment(result), 1));
}
...
fn module_00() {
    ...
    assert_eq!(l.next(), Token::from((Symbol::Module, 1)));
    ...
    assert_eq!(l.next(), Token::from((Symbol::OpeningBrace, 1)));

    assert_eq!(l.next(), Token::from((Symbol::ClosingBrace, 1)));
    assert_eq!(l.next(), Token::new(TokenClass::EndOfProgram, 1));
}
...
fn module_wire_00() {
    ...
    assert_eq!(l.next(), Token::from((Symbol::OpeningBrace, 1)));
    assert_eq!(l.next(), Token::from((Symbol::Wire, 1)));
    assert_eq!(
        l.next(),
        Token::from((TokenClass::Identifire("ok".to_string()), 1))
    );
    assert_eq!(l.next(), Token::from((Symbol::Semicolon, 1)));
...
fn module_wire_01() {
    ...
    assert_eq!(l.next(), Token::from((Symbol::LeftSquareBracket, 1)));
    assert_eq!(
        l.next(),
        Token::from((TokenClass::Number("12".to_string()), 1))
    );
    assert_eq!(l.next(), Token::from((Symbol::RightSquareBracket, 1)));
    assert_eq!(l.next(), Token::from((Symbol::Semicolon, 1)));
    assert_eq!(l.next(), Token::from((Symbol::ClosingBrace, 1)));
    assert_eq!(l.next(), Token::new(TokenClass::EndOfProgram, 1));
    assert_eq!(l.next(), Token::new(TokenClass::EndOfProgram, 1));
...
fn reg_00() {
    ...
    assert_eq!(l.next(), Token::from((Symbol::Reg, 1)));
    assert_eq!(
        l.next(),
...
fn func_self_00() {
    ...
    assert_eq!(l.next(), Token::new(TokenClass::Symbol(Symbol::Comma), 1));
    assert_eq!(
        l.next(),
    ...
    assert_eq!(l.next(), Token::new(TokenClass::Symbol(Symbol::Colon), 1));
    assert_eq!(
        l.next(),
        Token::from((TokenClass::Identifire("c".to_string()), 1))
    );
...
fn proc_00() {
    ...
    assert_eq!(l.next(), Token::from((Symbol::OpeningBrace, 1)));
    assert_eq!(l.next(), Token::from((Symbol::ProcName, 1)));
    assert_eq!(
        l.next(),
        Token::from((TokenClass::Identifire("proc_a".to_string()), 1))
    );
    assert_eq!(l.next(), Token::from((Symbol::LeftParen, 1)));
    assert_eq!(l.next(), Token::from((Symbol::RightParen, 1)));
...
fn state_name_00() {
    ...
    assert_eq!(l.next(), Token::from((Symbol::OpeningBrace, 1)));
    assert_eq!(l.next(), Token::from((Symbol::StateName, 1)));
    assert_eq!(
        l.next(),
...
fn mem_00() {
    ...
    assert_eq!(l.next(), Token::from((Symbol::OpeningBrace, 1)));
    assert_eq!(l.next(), Token::from((Symbol::Mem, 1)));
    assert_eq!(
        l.next(),
        Token::from((TokenClass::Identifire("aa".to_string()), 1))
    );
...
fn wire_assign_00() {
    ...
    assert_eq!(l.next(), Token::from((Symbol::Equal, 1)));
    assert_eq!(
        l.next(),
...
fn plus_00() {
    ...
    assert_eq!(l.next(), Token::from((Operator::Plus, 1)));
    assert_eq!(
        l.next(),
        Token::from((TokenClass::Number("1'b1".to_string()), 1))
    );
...
fn reg_assignment_00() {
    ...
    assert_eq!(l.next(), Token::from((Symbol::RegAssign, 1)),);
    assert_eq!(
        l.next(),
        Token::from((TokenClass::Identifire("a".to_string()), 1))
    );
...
fn func_block_00() {
    ...
    assert_eq!(l.next(), Token::from((Symbol::Func, 1)));
    assert_eq!(
        l.next(),
        Token::new(TokenClass::Identifire("test".to_string()), 1)
    );
...
fn func_block_return() {
    ...
    assert_eq!(l.next(), Token::from((Symbol::OpeningBrace, 1)));
    assert_eq!(l.next(), Token::from((Symbol::Return, 1)));
    assert_eq!(
        l.next(),
...
fn any_block_00() {
    ...
    assert_eq!(l.next(), Token::from((Symbol::Any, 1)));
    assert_eq!(l.next(), Token::from((Symbol::OpeningBrace, 1)));
    assert_eq!(l.next(), Token::from((Symbol::ClosingBrace, 1)));
}
...
fn or_00() {
    ...
    assert_eq!(l.next(), Token::from((Operator::Pipe, 1)));
    assert_eq!(
        l.next(),
        Token::from((TokenClass::Identifire("b".to_string()), 1))
    );
...
fn any_else_00() {
    ...
    assert_eq!(l.next(), Token::from((Symbol::Colon, 1)));
    assert_eq!(l.next(), Token::from((Symbol::OpeningBrace, 1)));
    assert_eq!(l.next(), Token::from((Symbol::ClosingBrace, 1)));
    assert_eq!(l.next(), Token::from((Symbol::Else, 1)));
    assert_eq!(l.next(), Token::from((Symbol::Colon, 1)));
...
fn gt_lt_00() {
    ...
    assert_eq!(l.next(), Token::from((Operator::GreaterEq, 1)));
    assert_eq!(
        l.next(),
        Token::new(TokenClass::Number("12'h3a0".to_string()), 1)
    );
    assert_eq!(l.next(), Token::from((Operator::LogicAnd, 1)));
    assert_eq!(
        l.next(),
        Token::from((TokenClass::Identifire("address".to_string()), 1))
    );
    assert_eq!(l.next(), Token::from((Operator::LessEq, 1)));
    assert_eq!(
        l.next(),
...
fn state_00() {
    ...
    assert_eq!(l.next(), Token::from((Symbol::State, 1)));
    assert_eq!(
        l.next(),
